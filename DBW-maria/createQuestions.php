  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <form action="createQuestions.php" method="post" enctype="multipart/form-data">
              <div class="w3-container w3-padding">
                <h2 class="w3">Share your doubts</h2>
                ...
                <div>
                  ...
                  <input type="hidden" name="Section" value="ForumPost">
                </div>
    ...
    <div class="w3-col m2">
        ...
        <div class="w3-container">
          ...
          <p><button onclick="location.href='forum.php'" class="w3-button w3-block w3-theme-l4"><i class="fa fa-home"></i> &nbsp;Go back</button></p>
        </div>
      </div>
      <br>
