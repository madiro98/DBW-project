...
$posts = array();
$postsTitle = 'Recent Questions';
//dd($posts);

if (isset($_POST['search-term'])){
  $postsTitle = "You searched for: '" . $_POST['search-term'] . "'";
  $posts = searchPosts(['Section' => 'ForumPost'], $_POST['search-term']);
} else {

  $posts = getPosts('Section',['Section' => 'ForumPost'], 'Date');
}
    ...
    <div class="w3-col m2">
      <div class="w3-card w3-round w3-white w3-center">
        <div class="w3-container">
          ...
          <p><button onclick="location.href='createQuestions.php'" class="w3-button w3-block w3-theme-l4"><i class="fa fa-pencil"></i> &nbsp;Write question</button></p>
        </div>
      </div>
      <br>
